...
**Leaderboard : Setup Project** Leaderboard list app . First working version, without styling, following a wireframe . Use ES6, Webpack, GitFlow
...
Open index.html using webpack server extension.
